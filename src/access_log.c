...
//
snprintf(t_timestamp,13,"%9ld.%03d", (long int)current_time.tv_sec,( (int)current_time.tv_usec / 1000));
...
if( (my_pl != (struct shaga_plugin *) 1) ){
  my_pl->storeToDatabase(t_timestamp,t_user,t_ip,t_byte); /* write to db TIMESTAMP ,USER ,IP ,BYTE */
